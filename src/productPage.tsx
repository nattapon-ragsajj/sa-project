...
export default function ProductProduce() {
  ...
  const [items] = useState<Item[]>([
    { id: 1, name: "ชาเขียวมัทฉะ 500ml", status: "update", group: "ชา" },
    { id: 2, name: "คุกกี้ช็อกชิพ", status: "update", group: "คุกกี้" },
  ]);
      ...
      <div className="cards">
        {items.map((it) => (
          <article key={it.id} className="prod-card">
            ...
            {/* หากต้องการปุ่มขวา ค่อยเปิดส่วนนี้
            <div className="prod-actions">
              <button className="btn primary" onClick={() => handleCreateProductClick(it)}>สั่งผลิต</button>
